...
::: text-center
We've made a short video explaining how to play the game. Full instructions for [setup](rules.qmd#sec-setup), [gameplay](rules.qmd#sec-gameplay), [round end](rules.qmd#sec-round-end), and [game end](rules.qmd#sec-game-end) are detailed below.
:::
...
<img src="/images/cards/turnOrder.jpg" width="250px"/>
::::
